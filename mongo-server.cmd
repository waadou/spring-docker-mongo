...
@REM            named spring-docker-mongo-db from it.
@REM            
@REM REV LIST:  
@REM    DATE:  
@REM    BY:  
...
set VOLUME_NAME=spring-docker-mongo-volume
...
set CONTAINER_NAME=spring-docker-mongo
...
set DOCKERFILE=db/Dockerfile.mongo
